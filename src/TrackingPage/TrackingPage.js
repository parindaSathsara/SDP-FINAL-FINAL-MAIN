...
function TrackingPage() {
    ...
    return (
        <div classNameName="TrackingPageContainer">
            ...
            <div className="container trackingContainer padding-bottom-3x mb-1">


                <img src={Image} class="rounded mx-auto d-block logoImgTracking" alt=""></img>

                <h3 class='text-center trackingPortalTitle'>TRACKING PORTAL</h3>
                <div className="card trackingContainerCard mb-3">
                    <div className="p-4 text-center text-white text-lg bg-dark rounded-top trackingNumberContainer">
                        ...
                        <div className="form-group row TrackingNumberForm">
                            <label for="TrackingNumber" class="col-sm-3 col-form-label trackingNumberLabel">Tracking Number</label>
